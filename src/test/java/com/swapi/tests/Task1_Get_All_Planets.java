...
/**
 * @author rakesh
 * This class is created to hold all the test cases which consumes 
 * SWAPI for testing Get All Planets *
 */
/**
 * @author rakes
 *
...
public class Task1_Get_All_Planets extends RestAPITester {
	...
	/**
	 * This method consumes SWAPI for Planet resources
	 * and validates Http Status Code: 200
	 * @throws ClientProtocolException
	 * @throws IOException
	...
	/**
	 * This method consumes SWAPI for Planet resources
	 * and validates attributes of the planet resources
	 * @throws ClientProtocolException
	 * @throws IOException
	...
	/**
	 * This method consumes SWAPI for Planet resources
	 * and validates search functionality of the planet resources
	 * @throws ClientProtocolException
	 * @throws IOException
	 * @throws ParseException
	 * @throws JSONException
	...
	public static void Auto_SWAPI_GET_ALL_Test_004()
		...
		Assert.assertEquals(getServiceStatusCode("http://swapi.co/api/planets/?search=" + searchString), HttpStatus.SC_OK);
	...
	/**
	 * This method consumes SWAPI for Planet resources
	 * and validates return code is 404 NOT FOUND for invalid
	 * @throws ClientProtocolException
	 * @throws IOException
	 * @throws JSONException
	 */
