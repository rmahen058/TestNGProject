...
public class MongoDBJDBC {
	...
	public static void createMongoDB(String dbName) throws UnknownHostException {
			...
			Reporter.log("Connected to Database: 'swapi'", reporterFlag);
			...
			Reporter.log("Collections selected successfully: 'planets'", reporterFlag);
	}	
	...
	public static void insertToMongoDB(List<Planet> lstPlanets) {
		...
		for (Planet objPlanet : lstPlanets)
		{
			...
			Reporter.log("# of Planet record inserted --> "+iCount);
			iCount ++;
		}
	}
	...
	public static void dropMongoDB() {
		db.dropDatabase();
		Reporter.log("Database dropped successfully", reporterFlag);
	}
}
